...
class Contact_Header_Widget extends \Elementor\Widget_Base {
    ...
    protected function render() {
        ...
        <section class=py-12 lg:py-30">
            <div class="container">
                <div class="grid grid-cols-5 gap-10 xl:gap-20">
                    <div class="col-span-5 lg:col-span-2">
                        <div class="sticky top-25">
                            <p class="text-xl font-medium mb-8">
                                <span><?php echo esc_html($settings['breadcrumb_text']); ?></span> - 
                                <a href="<?php echo esc_url($settings['breadcrumb_link']['url']); ?>" class="underline underline-offset-1 hover:brightness-80">Page Link</a>
                            </p>
                            <div class="mb-8">
                                <h3 class="text-6xl font-black mb-6"><?php echo esc_html($settings['title']); ?></h3>
                                <p class="text-lg"><?php echo esc_html($settings['description']); ?></p>
                            </div>
                            <ul class="space-y-4">
                                <?php if ($settings['email']) : ?>
                                    <li>
                                        <a href="mailto:<?php echo esc_attr($settings['email']); ?>" class="flex items-center gap-4 hover:brightness-80">
                                ...
                                <?php if ($settings['phone']) : ?>
                                    <li>
                                        <a href="tel:<?php echo esc_attr($settings['phone']); ?>" class="flex items-center gap-4 hover:brightness-80">
                                            <svg class="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="col-span-5 lg:col-span-3">
                        <?php if ($settings['form_type'] === 'hubspot'): ?>
                            <?php echo $settings['hubspot_embed_code']; ?>
                        <?php else: ?>
