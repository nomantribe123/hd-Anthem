...
while ($blog_query->have_posts()) {
    ...
    ?>
    <li class="min-h-159 h-full flex flex-col justify-end p-4"
        style="background-image: linear-gradient(180deg, rgba(49, 52, 74, 0) 40.66%, rgba(49, 52, 74, 0.8) 59.81%), url('<?php echo esc_url($featured_image); ?>'); background-size: cover; background-position: center; background-repeat: no-repeat;">
        <div>
            <div class="mb-6 lg:mb-14">
                <div class="text-center mb-6">
                    <p class="text-xs lg:text-base text-white font-bold font-din-next-stencil uppercase mb-2"><?php echo esc_html($category_name); ?></p>
                    <h4 href="<?php the_permalink(); ?>" class="text-2xl font-black uppercase mb-2"><?php the_title(); ?></h4>
            ...
            <a href="<?php the_permalink(); ?>"
                class="group w-fit h-11 flex justify-center items-center gap-3 bg-white/12 backdrop-blur-2xl px-6 btn mx-auto">
